...
export function PartnersSection() {
  return (
    <section
      className="pt-16 pb-10 md:pt-20 md:pb-12 lg:pt-24 lg:pb-14"
    ...
    >
      <div className="container-amc">
        ...
        <div className="mt-10 text-center">
          <Link href="/gammes" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-transparent text-amc-text font-semibold rounded-lg border-2 border-amc-text hover:bg-amc-text hover:text-white active:scale-95 transition-all duration-200">
